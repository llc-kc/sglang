...
def build_full_draft_pools(
    *,
    ...
    """Build ordinary draft pools derived from the target full KV indices."""
...
def build_swa_draft_pools(
    *,
    ...
    """Build draft SWA pools derived from the target SWA indices."""
    ...
    if isinstance(target_swa_host_pool, DeepSeekV4PagedHostPool):
        ...
        host_to_device_ratio = (
            max(target_swa_host_pool.size - target_swa_host_pool.page_size, 0)
            / draft_swa_pool.size
        )
